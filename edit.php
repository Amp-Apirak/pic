...
<?php
    if (isset($_POST['submit'])) { /* ถ้า POST มีการกด Submit ให้ทำส่วนล่าง */
        ...
        if($file_upfile !=''){
            ...
            move_uploaded_file($file_tmp, "../pic/example/$file_upfile");
            ...
            move_uploaded_file($file_tmp, "../pic/test/$file_test");
                            ...
                            if ($result) {
                                //     // <!-- sweetalert -->
                                    echo '<script>
                                        ...
                                        $sMessage .= "ติดตามงานได้ที่ Link Web: http://58.137.58.163/pic/view.php?id=$_GET[id] \n\n";
                                        $sMessage .= "@All \n";
